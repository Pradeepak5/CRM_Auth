...
export default function Manager_AddEmployee() {
  ...
  const AddNewEmployee = async (newEmployee) => {
    ...
    try {
        const res = await axios.post(`${url}/manager/addemployee`, newEmployee);
  ...
  return (
    <div>
      ...
      >
        ...
        <button type="button" className='btn btn-danger' onClick={()=>navigate('/manager/dashboard')}>Cancel</button>
